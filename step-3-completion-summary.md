...
- [ ] Real UI screenshots (authentic, may need updates as UI evolves)
...
⏳ **Decision** on screenshot strategy  
...
2. **Coordinate screenshot capture** (provide detailed specs)
...
- 📁 [`src/components/screens/LandingContent/`](./src/components/screens/LandingContent/) - All landing components
- 📄 [`src/i18n/locales/en.json`](./src/i18n/locales/en.json) - English translations (lines 950-1050+)
...
- Screenshot capture plan finalized
...
- Confirm screenshot strategy preference
...
⚠️ **Risk:** New screenshots date quickly as UI evolves  
**Mitigation:** Use CSS overlays to highlight features, not exact UI states  

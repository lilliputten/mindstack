...
export const authorTgUrl = `https://t.me/${authorTgId}`;
export const authorGithub = 'https://github.com/lilliputten';
export const projectGithub = 'https://github.com/lilliputten/mindstack';
export const authorLinkedin = 'https://linkedin.com/in/lilliputten';

export const contactEmail = 'mindstack@lilliputten.com';

export const russianTIN = '772857225118'; // Russian TIN (INN) number
export const internationalTIN = '31011746860014'; // International TIN (UZ PINFL) number
export const russianPhone = '+7 903 225-83-00'; // Russian phone
export const internationalPhone = '+998 97 877-11-74'; // International (UZ) phone

/** Site default url. See also `VERCEL_PROJECT_PRODUCTION_URL` and `PUBLIC_URL` in the server environment */
// export const publicAddr = 'https://mindstack.lilliputten.com/';

export const effectivePrivacyDate = new Date('2025.01.01');

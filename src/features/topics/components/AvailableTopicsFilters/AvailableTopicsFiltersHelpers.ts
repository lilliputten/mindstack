...
export function getFiltersDataRawValueString(
  ...
  /* // TODO: Other types?
   * const { typeName } = baseField._def;
   * const isUnion = typeName === 'ZodUnion';
   * const isString = baseField instanceof z.ZodString;
   * const isNumber = baseField instanceof z.ZodNumber || baseField instanceof z.ZodBigInt;
   */

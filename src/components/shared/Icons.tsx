...
export const Gem: IconType = ({ ...props }: IconProps) => (
  <svg
    aria-hidden="true"
    focusable="false"
    data-prefix="far"
  ...
  >
    <path
      fill="currentColor"
      d="M87.7 237.6c0 1.1-.1 2.3-.1 3.4c0 4.2 .5 8.3 1.3 12.4L0 128 128 0l109.6 109.6L256 0l128 128l-88.9 125.4c.8-4.1 1.3-8.2 1.3-12.4c0-1.1 0-2.3-.1-3.4c0-.8-.1-1.6-.1-2.4c0-70.7-57.3-128-128-128S0 164.5 0 235.2c0 .8 0 1.6 .1 2.4zm21.2 38.3c-.3-1.1-.6-2.1-.8-3.2c-.2-1-.3-2.1-.4-3.1c-.1-1-.1-2-.1-3c0-1 0-2 .1-3c.1-1 .2-2.1 .4-3.1c.2-1 .5-2.1 .8-3.2L128 128 87.7 237.6c.1-.6 .2-1.1 .3-1.7c.1-.6 .1-1.2 .2-1.8c.1-.6 .1-1.2 .1-1.8c0-.6 0-1.2-.1-1.8c0-.6-.1-1.2-.2-1.8c-.1-.6-.2-1.1-.3-1.7zm316.2 0c-.1 .6-.2 1.1-.3 1.7c-.1 .6-.1 1.2-.2 1.8c-.1 .6-.1 1.2-.1 1.8c0 .6 0 1.2 .1 1.8c0 .6 .1 1.2 .2 1.8c.1 .6 .2 1.1 .3 1.7L384 128l-40.3 109.6c.3 1.1 .6 2.1 .8 3.2c.2 1 .3 2.1 .4 3.1c.1 1 .1 2 .1 3c0 1 0 2-.1 3c-.1 1-.2 2.1-.4 3.1c-.2 1-.5 2.1-.8 3.2zM256 64c-94.8 0-171.7 76.9-171.7 171.7c0 94.8 76.9 171.7 171.7 171.7s171.7-76.9 171.7-171.7C427.7 140.9 350.8 64 256 64zM128 128l128 128 128-128-128-128L128 128zm256 256L256 256 128 384l128 128 128-128z"
    />
  </svg>
);

  ...
  >
    <AccordionPrimitive.Trigger
      ...
      className={cn(
        ...
        'flex flex-1 items-center justify-between gap-4 overflow-hidden py-4 text-left font-medium transition-all max-sm:text-sm [&[data-state=open]>svg]:rotate-180',
        className,
      )}
      {...props}
    >

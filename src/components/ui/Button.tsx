...
export const buttonVariants = cva(
  ...
  ),
  {
    variants: {
      variant: {
        default: 'bg-theme on-theme hover:bg-theme/90',
        primary: 'bg-primary text-primary-foreground hover:bg-primary-600',
        theme: 'bg-theme on-theme hover:bg-theme-600',
        ...
        ghost: 'hover:bg-theme/20 active:bg-theme active:on-theme',
        ghostForm: cn(
          'border',
          'border-input',
          'bg-background/50',
          ...
          'focus:ring-ring',
          'focus:ring-offset-2',
          'active:bg-theme active:on-theme',
        ),
        ...
        ghostOnTheme: 'on-theme hover:bg-theme-600/50',

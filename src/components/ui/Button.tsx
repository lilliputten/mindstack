...
export const classOptions = {
  variant: {
    ...
    theme50: 'bg-theme/50 text-theme-foreground hover:bg-theme-600/50',
    theme80: 'bg-theme/80 text-theme-foreground hover:bg-theme-600/80',
    'theme-tr': 'bg-theme/50 text-theme-foreground hover:bg-theme-600/50',
    'theme-gr1': 'bg-theme-gr1 hover:brightness-120',
    gr1: 'bg-gr1 hover:brightness-120 text-white',
    gr1r: 'bg-gr1r hover:brightness-120 text-white',
    gr2: 'bg-gr2 hover:brightness-120 text-white',
    gr2r: 'bg-gr2r hover:brightness-120 text-white',
    gr3: 'bg-gr3 hover:brightness-120 text-white',
    gr3r: 'bg-gr3r hover:brightness-120 text-white',
    gr4: 'bg-gr4 hover:brightness-120 text-white',
    gr4r: 'bg-gr4r hover:brightness-120 text-white',
    themeInverted: 'bg-foreground text-theme-600 hover:bg-theme-200 hover:text-theme-700',

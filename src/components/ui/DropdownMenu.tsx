...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      isDev && '__DropdownMenuSubTrigger', // DEBUG
      'flex',
      'cursor-default',
      'select-none',
      'items-center',
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      isDev && '__DropdownMenuSubContent', // DEBUG
      'text-on-popover',
      'z-50',
      'min-w-32',
      'overflow-hidden',
...
>(({ className, viewportClassName, sideOffset = 4, children, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        isDev && '__DropdownMenuContent', // DEBUG
        'z-50',
        'min-w-32',
        'overflow-hidden',
        'rounded-md',
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      isDev && '__DropdownMenuItem', // DEBUG
      'relative',
      'flex',
      'cursor-default',
      'select-none',
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Arrow ref={ref} className={cn(className)} {...props} />
));

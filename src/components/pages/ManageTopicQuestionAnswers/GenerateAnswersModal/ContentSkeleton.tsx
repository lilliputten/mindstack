...
export function InnerContentSkeleton({
  ...
  return (
    <div
      className={cn(
        isDev && '__GenerateAnswersModal_InnerContentSkeleton', // DEBUG
...
export function ContentSkeleton({ className }: TPropsWithClassName) {
  return (
    <div
      className={cn(
        isDev && '__GenerateAnswersModal_ContentSkeleton', // DEBUG
    ...
    >
      {false && isDev && (
        <div className="text-sm opacity-50">__GenerateAnswersModal_ContentSkeleton</div>
      )}

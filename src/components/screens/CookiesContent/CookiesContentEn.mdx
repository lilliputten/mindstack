...
This Cookie Policy explains how MindStack ("we," "our," or "us") uses cookies and similar technologies when you visit our memory training application.
...
- **Right to object:** Opt out of certain cookie uses

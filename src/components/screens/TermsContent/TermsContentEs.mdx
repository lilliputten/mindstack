...
Bienvenido a MindStack ("nosotros," "nuestro," o "nos"). Estos Términos de Servicio ("Términos") rigen su uso de nuestra aplicación de entrenamiento de memoria y servicios.

## Aceptación de los Términos

Al acceder o usar MindStack, usted acepta estar sujeto a estos Términos. Si no está de acuerdo con alguna parte de estos términos, no puede acceder al servicio.
...
- Nos esforzamos por mantener la disponibilidad del servicio pero no podemos garantizar acceso ininterrumpido
- Podemos suspender temporalmente el servicio para mantenimiento
- No somos responsables de las interrupciones del servicio
...
- El servicio se proporciona "tal como está" sin garantías
- No garantizamos resultados específicos del uso de nuestro entrenamiento de memoria
- No somos responsables de ningún daño que surja del uso del servicio

## Limitación de Responsabilidad

En la máxima medida permitida por la ley, MindStack no será responsable de ningún daño indirecto, incidental, especial o consecuente.

## Indemnización

Usted acepta indemnizar y eximir de responsabilidad a MindStack de cualquier reclamo que surja de su uso del servicio o violación de estos Términos.

## Cambios a los Términos

Podemos actualizar estos Términos de vez en cuando. Le notificaremos de cualquier cambio publicando los nuevos Términos en esta página.
